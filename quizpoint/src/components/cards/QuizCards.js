        ...
        <div className="bg-slate-100 shadow-md w-[21rem] h-[23rem] rounded-lg border-slate-300 border">
            ...
            <div className="h-auto">
                ...
                <div className="flex h-20 pt-2 align-middle justify-center items-center rounded-b-lg ">
                    {props.graphType === "bar" && <a href={`/quiz/${props.quiz.code}`}><button className="overflow-hidden bg-indigo-700 before:bg-primary-100 before:bottom-0 before:left-0 before:h-full before:w-full before:-translate-x-full hover:before:translate-x-0 before:transition before:ease-in-out before:duration-500"><p className="relative z-0 text-white transition ease-in-out duration-500">Start Quiz</p></button></a>}
                    {props.graphType === "doughnut" && <a href={`/quiz/${props.quiz.code}`}><button className="overflow-hidden   bg-indigo-700 before:bg-primary-100 before:bottom-0 before:left-0 before:h-full before:w-full before:-translate-x-full hover:before:translate-x-0 before:transition before:ease-in-out before:duration-500"><p className="relative z-0 text-white transition ease-in-out duration-500">Resubmit</p></button></a>}
                </div>
            </div>
        </div>
    )
